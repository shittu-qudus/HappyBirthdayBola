...
const chapters = [
  {
    ...
    body: '{{Describe where and how you first met — a chance encounter, a mutual friend, or a moment that felt like destiny. Write it the way you would tell a stranger who deserves to know.}}',
    note: '{{Place — City, Venue, or Platform}}',
    photo: 'src/images/marriot.jpeg',
  ...
  },
  {
    ...
    body: '{{What did you talk about? Was there a spark, a shared laugh, a moment where you knew this was different? Write the exact words and the exact feeling you still remember.}}',
    note: '{{What she said that made you smile first}}',
    photo: 'src/images/retro1.jpeg',
  ...
  },
  {
    ...
    body: '{{What did you think of her the first time you truly saw her? Be honest and beautiful about it. What stood out — her smile, her laugh, her eyes, the quiet way she carries herself?}}',
    note: '{{The one detail you noticed immediately}}',
    photo: 'src/images/retro2.jpeg',
  ...
  },
  {
    ...
    body: "{{Share an inside joke, an embarrassing first moment, or a funny memory only the two of you would understand. Something that still makes you both laugh whenever it surfaces.}}",
    note: '{{Your inside joke or the line only you two know}}',
    photo: 'src/images/home1.jpeg',
