...
const milestones = [
  {
    ...
    desc: 'The moment our paths crossed and the universe decided we were meant to meet. That first conversation that felt different, special, like the start of something beautiful.',
  ...
  },
  {
    ...
    desc: 'Ikeja, Marriot Hotel — butterflies in my stomach, smiles we couldn\'t hide, and a connection that felt like coming home. The beginning of our story.',
    Icon: FiMap,
  ...
  },
  {
    ...
    desc: 'The moment we decided to freeze time and keep a memory forever. That first picture that captured not just our faces, but the happiness between us.',
    Icon: FiCamera,
  ...
  },
  {
    ...
    desc: 'The trip that became our story discovering new places, making memories, and finding that every journey is better when you\'re by my side.',
    Icon: FiMap,
  ...
  },
  {
    ...
    desc: 'A milestone that changed everything when we realized this was more than just a moment, it was a lifetime in the making. Our forever started here.',
    Icon: FiAnchor,
  ...
  },
  {
    ...
    desc: 'The birthday that reminds me how blessed I am to have you in my life. This year together has been a gift, and I pray the best is yet to come for you.',
    Icon: FiGift,
